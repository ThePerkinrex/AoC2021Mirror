...
# Lenguajes
Esta escrito por ahora en 3 lenguajes: Rust, Python, JavaScript(NodeJS) y Java,  
por lo que hacen falta los comandos `cargo`, `python`, `node`, `javac` y `java` para funcionar
